...
function spawnPreview(root) {
  const viteCli = path.join(root, "node_modules", "vite", "bin", "vite.js");
  if (!existsSync(viteCli)) {
    return new Error(`未找到 Vite：${viteCli}\n请先在本项目根目录执行 npm install`);
  }
  ...
  serverProcess = spawn(node, [viteCli, "preview", "--host", "127.0.0.1", "--port", String(PREVIEW_PORT)], {
    cwd: root,
    env: { ...process.env, NODE_ENV: "production", MPG_PROJECT_ROOT: root },
    stdio: "pipe",
  });
